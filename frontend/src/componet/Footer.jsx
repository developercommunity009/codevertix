        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
            ...
            <div className="md:col-span-8 md:grid-cols-3 lg:col-span-7 grid sm:grid-cols-1 gap-8">
              ...
              <div className="text-sm">
                ...
                <ul>
                  ...
                  <li className="mb-1">
                    <Link href="/" className="text-[#152330]/50 flex items-center hover:text-[#5287b9] transition duration-150 ease-in-out">United States <img className=" h-6" src="https://e7.pngegg.com/pngimages/422/950/png-clipart-round-flag-of-usa-art-flag-of-the-united-states-english-spoken-language-american-us-flag-miscellaneous-english.png" alt="pic" /></Link>
                  </li>
                  {/* <li className="mb-1">
          ...
          <div className="md:flex md:items-center md:justify-between">
            ...
            <ul className="flex mb-4 md:order-1 md:ml-4 md:mb-0">
              <li>
                <Link href="/" className="flex justify-center items-center text-[#152330] bg-gray-500 hover:text-gray-100 hover:bg-[#152330] rounded-full transition duration-150 ease-in-out" aria-label="Twitter">
              ...
              <li className="ml-4">
                <Link href="/" className="flex justify-center items-center text-[#152330] bg-gray-500 hover:text-gray-100 hover:bg-[#152330] rounded-full transition duration-150 ease-in-out" aria-label="Github">
                  <svg className="w-8 h-8 fill-current" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
              ...
              <li className="ml-4">
                <Link href="/" className="flex justify-center items-center text-[#152330] bg-gray-500 hover:text-gray-100 hover:bg-[#152330] rounded-full transition duration-150 ease-in-out" aria-label="Facebook">
                  <svg className="w-8 h-8 fill-current" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
              ...
              <li className="ml-4">
                <Link href="/" className="flex justify-center items-center text-[#152330] bg-gray-500 hover:text-gray-100 hover:bg-[#152330] rounded-full transition duration-150 ease-in-out" aria-label="Instagram">
                  <svg className="w-8 h-8 fill-current" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
